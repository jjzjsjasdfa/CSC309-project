...
export default function Dashboard(props) {
    ...
    if(!token){
      ...
      const fetchUserData = async () => {
        try {
          ...
          // failure
          if (!res.ok) {
            console.error(`Error: ${fetchedUser.message}`);
          }

          // success
          storeCurrentUser(fetchedUser);
          setUser(fetchedUser);
  ...
  const avatarFullUrl = user.avatarUrl ? `${VITE_BACKEND_URL}${user.avatarUrl}` : null;
